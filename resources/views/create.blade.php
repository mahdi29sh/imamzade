        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-2">
                <div class="panel panel-default" style="direction:rtl;text-align:right;">
                    <div class="panel-heading"><h2>اضافه کردن امامزاده</h2></div>
                    ...
                    <div class="panel-body" >
                        <form class="form-horizontal " method="POST" action="{{ route('imamzade.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('imamzade_Name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="imamzade_Name" type="text" class="form-control" name="imamzade_Name" value="{{ old('imamzade_Name') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('Ancestor') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="Ancestor" type="text" class="form-control" name="Ancestor" value="{{ old('Ancestor') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('latitude') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="latitude" type="number" step="0.000001" class="form-control" name="latitude" value="{{ old('latitude') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('longitude') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="longitude" type="number" step="0.000001" class="form-control" name="longitude" value="{{ old('longitude') }}" required>
